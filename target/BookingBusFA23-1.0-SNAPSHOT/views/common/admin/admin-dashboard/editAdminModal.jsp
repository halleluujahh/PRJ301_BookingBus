<%-- 
    Document   : editAdminModal
    Created on : Oct 30, 2023, 9:42:24 AM
    Author     : LENOVO
--%>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editAdminModalLabel">Edit Admin Form</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="editAdminForm" action="dashboard?action=edit-admin" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" form="editAdminForm" onclick="validateAdminForm2()">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function editAdminModal(username, firstname, lastname, email, phone, address, image) {
